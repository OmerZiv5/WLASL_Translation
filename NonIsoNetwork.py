...
# -----------------------------
# Dataset and Stratified Train/Test Split
# -----------------------------
full_dataset = WLASLDataset("differences", transform=None)

train_indices, test_indices = train_test_split(
    range(len(full_dataset)),
    test_size=0.2,
    stratify=full_dataset.labels_encoded,
    random_state=42
)
...
if _name_ == '_main_':
    ...
    for epoch in range(epochs):
        ...
        print(f"Epoch [{epoch+1}/{epochs}] "
              ...
              f"Val Loss: {val_loss:.4f}, Val Acc: {val_acc:.2f}%\0n")
